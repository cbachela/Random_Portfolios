  ...
  sim_1_cons <- BT1_fev2cons$output$simulations
  ...
  sim_2_cons <- BT2_fev2cons$output$simulations
  ...
  sim_3_cons <- BT3_fev2cons$output$simulations
  ...
  sim_4_cons <- BT4_fev2cons$output$simulations
  ...
  sim_5_cons <- BT5_fev2cons$output$simulations
  ...
  sim_6_cons <- BT6_fev2cons$output$simulations
  
  BT7 <- loadBacktest( wd = paste0(wd_data, "waRehouse/"), name = "grw_multifac_usa_momctrl" )
  BT7_fev2cons <- loadBacktest( wd = paste0(wd_data, "waRehouse/"), name = "grw_multifac_usa_momctrl_fev2cons" )
  sim_7 <- BT7$output$simulations
  sim_7_cons <- BT7_fev2cons$output$simulations
  
  BT8 <- loadBacktest( wd = paste0(wd_data, "waRehouse/"), name = "grw_multifac_usa_valqualsizemomctrl" )
  BT8_fev2cons <- loadBacktest( wd = paste0(wd_data, "waRehouse/"), name = "grw_multifac_usa_valqualsizemomctrl_fev2cons" )
  sim_8 <- BT8$output$simulations
  sim_8_cons <- BT8_fev2cons$output$simulations
  ...
  w_array_1 <- list2array( L = BT1$output[ grepl("grw", names(BT1$output)) ] )
  w_array_2 <- list2array( L = BT2$output[ grepl("grw", names(BT2$output)) ] )
  w_array_3 <- list2array( L = BT3$output[ grepl("grw", names(BT3$output)) ] )
  w_array_4 <- list2array( L = BT4$output[ grepl("grw", names(BT4$output)) ] )
  w_array_5 <- list2array( L = BT5$output[ grepl("grw", names(BT5$output)) ] )
  w_array_6 <- list2array( L = BT6$output[ grepl("grw", names(BT6$output)) ] )
  w_array_7 <- list2array( L = BT7$output[ grepl("grw", names(BT7$output)) ] )
  w_array_8 <- list2array( L = BT8$output[ grepl("grw", names(BT8$output)) ] )
  
  # w_array_1 <- list2array( L = BT1_fev2cons$output[ grepl("grw", names(BT1_fev2cons$output)) ] )
  # w_array_2 <- list2array( L = BT2_fev2cons$output[ grepl("grw", names(BT2_fev2cons$output)) ] )
  # w_array_3 <- list2array( L = BT3_fev2cons$output[ grepl("grw", names(BT3_fev2cons$output)) ] )
  # w_array_4 <- list2array( L = BT4_fev2cons$output[ grepl("grw", names(BT4_fev2cons$output)) ] )
  # w_array_5 <- list2array( L = BT5_fev2cons$output[ grepl("grw", names(BT5_fev2cons$output)) ] )
  # w_array_6 <- list2array( L = BT6_fev2cons$output[ grepl("grw", names(BT6_fev2cons$output)) ] )
  # w_array_7 <- list2array( L = BT7_fev2cons$output[ grepl("grw", names(BT7_fev2cons$output)) ] )
  # w_array_8 <- list2array( L = BT8_fev2cons$output[ grepl("grw", names(BT8_fev2cons$output)) ] )
  ...
  # lSim_fev2cons <- list( mfac = BT1_fev2cons$output$simulations,
  #                        mfac_val_ctrl = BT2_fev2cons$output$simulations,
  #                        mfac_qual_ctrl = BT3_fev2cons$output$simulations,
  #                        mfac_size_ctrl = BT4_fev2cons$output$simulations,
  #                        mfac_size_stdz_ctrl = BT5_fev2cons$output$simulations,
  #                        mfac_val_qual_size_ctrl = BT6_fev2cons$output$simulations,
  #                        mfac_mom_ctrl = BT7_fev2cons$output$simulations,
  #                        mfac_val_qual_size_mom_ctrl = BT8_fev2cons$output$simulations )
  ...
  # 
  # saveRDS( object = env, file = paste0(wd_data, "waRehouse/rp_grw_multifac_usa_factor_control_analze.rds") )
  ...
  env <- readRDS( file = paste0(wd_data, "waRehouse/rp_grw_multifac_usa_factor_control_analze.rds") )
  ...
  ylim_is <- range( unlist( lapply( lStats_is, FUN = function(x) { x[[fac_name]]$stats["means", ] } ) ) )
  ylim_oos <- range( unlist( lapply( lStats_oos, FUN = function(x) { x[[fac_name]]$stats["means", ] } ) ) )
  mfrow <- c(4, 2)
  ...
  range( lStats_oos[[ "mfac_val_ctrl" ]][[ "value" ]]$stats["sds", ] )
  range( lStats_oos[[ "mfac_val_ctrl" ]][[ "value" ]]$stats["means", ] )
  ...
  # sim_all <- na.omit( cbind( X_bm[ ,strategy_names], lSim_fev2cons[["mfac_val_qual_size_ctrl"]]) )
